...
def get_network(network_config):
    ...
    if network_config.pretrained:
        if type(net) is dict:
            ...
            model = net
            # model = CoOp_IDLikePrompt(config, criterion='cosine', arch="ViT-B/16", device='cuda',
            ...
            model_checkpoint_save_path = os.path.join(network_config.output_dir, 'model_checkpoint.pth')
